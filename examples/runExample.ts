...
const findContributors = new mariner.ContributorFetcher(config);
...
findContributors.fetchContributorsByRepoName(token, repositoryIdentifiers).then((contributors) => {
